...
class LancamentoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'valor_total': forms.TextInput(attrs={'class': 'form-control decimal-mask', 'placeholder':'R$ 0,00'}),
            'abatimento': forms.TextInput(attrs={'class': 'form-control decimal-mask', 'placeholder':'R$ 0,00'}),
